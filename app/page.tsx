      ...
      <div className="w-full max-w-md text-center bg-black/80 border-2 border-yellow-600 rounded-xl p-8 shadow-2xl relative pt-16">
        ...
        <div className="space-y-6">
          <Link href="/index-nfl" passHref legacyBehavior>
            <a className="w-full bg-yellow-400 hover:bg-yellow-500 text-amber-900 font-bold py-6 px-8 text-2xl rounded-full shadow-lg transition-all duration-200 flex flex-col items-center">
              <span>Games</span>

...
const NFL_QUESTION_POOL = [
  // ... (same as your original question list)
...
// --- Record score in triviaGameScores and update triviaAverages ---
async function recordTriviaGameScore(user: User | null, score: number, time: number) {
  try {
...
const NFLTrivia: React.FC = () => {
  ...
  const handleNextLevel = () => {
    if (currentLevel < 5) {
      ...
      recordTriviaGameScore(user, score, elapsedTime);
    }
  };
